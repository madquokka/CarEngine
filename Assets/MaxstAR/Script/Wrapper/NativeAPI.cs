...
namespace maxstAR
{
    internal class NativeAPI
    {
        ...
        [DllImport(MaxstARLibName)]
        public static extern bool CameraDevice_setZoom(float value);

        [DllImport(MaxstARLibName)]
        public static extern float CameraDevice_getMaxZoomValue();
        ...
        [DllImport(MaxstARLibName)]
        public static extern void CameraDevice_getBackgroundPlaneInfo(float[] values);
        #endregion
        ...
        [DllImport(MaxstARLibName)]
        public static extern void TrackerManager_setVocabulary(string vocFilename, bool assetFile);
        ...
        [DllImport(MaxstARLibName)]
        public static extern void CloudManager_JWTEncode(string secretKey, string payloadString, byte[] resultData);
        #endregion
        ...
        [DllImport(MaxstARLibName)]
        public static extern int GuideInfo_getTagAnchorsLength(ulong GuideInfo_cPtr);

        [DllImport(MaxstARLibName)]
        public static extern void GuideInfo_getTagAnchors(ulong GuideInfo_cPtr, char[] data, int length);
        #endregion
        ...
        [DllImport(MaxstARLibName)]
        public static extern void TrackedImage_getYuv420spY_UVPtr(ulong Image_cPtr, out IntPtr y_Ptr, out IntPtr uv_Ptr);

        [DllImport(MaxstARLibName)]
        public static extern ulong TrackedImage_getYuv420spY_U_VPtr(ulong Image_cPtr, out IntPtr y_Ptr, out IntPtr u_Ptr, out IntPtr v_Ptr);

        [DllImport(MaxstARLibName)]
        public static extern ulong TrackedImage_getYuv420_888YUVPtr(ulong Image_cPtr, out IntPtr y_Ptr, out IntPtr u_Ptr, out IntPtr v_Ptr, bool supportRG16Texture);
		#endregion
